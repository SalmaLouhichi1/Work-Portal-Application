...
import { useDeleteUserMutation, useGetTLSAdminsQuery} from "state/api";
...
const TLSAdmin = () => {
  ...
  const { data, isLoading } = useGetTLSAdminsQuery();
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Header title="TLS ADMINS" subtitle="Managing TLS Admins' list" />
